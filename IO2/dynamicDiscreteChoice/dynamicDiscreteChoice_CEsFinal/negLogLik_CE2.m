...
function [nll,negScore,informationMatrix] = ...
         negLogLik_CE2(choices,iX,supportX,capPi,beta,delta,rho,flowpayoffs,bellman,fixedPoint,tolFixedPoint)
rand_ind = rand(1,1);
rng(rand_ind)
%{
...
[capU0,capU1] = fixedPoint(u0,u1,capPi,rho,tolFixedPoint,bellman,rand(nSuppX,2),rand(nSuppX,2));   % w: changed here, still makes no difference?
deltaU = capU1-capU0;
